...
public class Book {
	...
	public static String[] getBookinformation() {
		String[] bookinformation = { id, bookname, String.valueOf(page), author, translator, publisher,
				publish_time.toString(), String.valueOf(price), String.valueOf(stock), booktype, };
