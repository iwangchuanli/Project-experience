...
%>
    <%@ page import="com.wcl.OnlineFriend.model.member.MemberInform"%>
<jsp:useBean id="loginedInform" type="com.wcl.OnlineFriend.model.member.MemberInform" scope="request"/>
	...
	<center>
		...
		<% if(loginedInform.isSelectOk()){ %>
			<font size=3>			
				...
				<br>个人简介：<jsp:getProperty name="loginedInform" property="message" />
