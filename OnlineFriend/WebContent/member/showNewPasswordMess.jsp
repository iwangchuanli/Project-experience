...
%> 
    <%@ page import="com.wcl.OnlineFriend.model.member.ModifyPassword"%>
<jsp:useBean id="password" type="com.wcl.OnlineFriend.model.member.ModifyPassword" scope="request"/>
