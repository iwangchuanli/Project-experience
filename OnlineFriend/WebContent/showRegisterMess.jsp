...
%>
    <%@ page import="com.wcl.OnlineFriend.model.member.Register"%>
<jsp:useBean id="register" type="com.wcl.OnlineFriend.model.member.Register" scope="request"/>
