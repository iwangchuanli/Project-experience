...
%>
    <%@ page import="com.wcl.OnlineFriend.model.article.ShowByPage"%>
<jsp:useBean id="showAllTitle" type="com.wcl.OnlineFriend.model.article.ShowByPage" scope="session"/>
...
<body background="image/article.jpg">	
	<center>
		<font size=3>
