...
%>
<%@ page import="com.wcl.OnlineFriend.model.member.Login"%>
<%@ page import="com.wcl.OnlineFriend.model.article.Article"%>
<jsp:useBean id="login" type="com.wcl.OnlineFriend.model.member.Login" scope="session"/>
<jsp:useBean id="toModifyArticle" type="com.wcl.OnlineFriend.model.article.Article" scope="request"/>
