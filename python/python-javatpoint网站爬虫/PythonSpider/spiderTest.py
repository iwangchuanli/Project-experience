# -*- coding: utf-8 -*-
# @Author: Marte
# @Date:   2019-04-12 09:46:54
# @Last Modified by:   Marte
# @Last Modified time: 2019-04-12 13:42:43
import requests
...
def getHTML(pageAddress):
    ...
    fileName = pageAddress[pageAddress.rindex('/')+1:]+'.html'
    # 图片提取拼接？
...
if __name__ == '__main__':
    targe = 'https://www.javatpoint.com/django-tutorial'
    getHTML(targe)
'''
