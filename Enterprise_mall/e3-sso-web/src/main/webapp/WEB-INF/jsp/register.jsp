	...
	<div class="reg_main reg_border regTab" id="perDiv">
		<ul class="individualUserBg">
			<form id="regForm_mod" name="regForm_mod" method="post">
				...
				<li class="regPl88"><span class="regM" style="margin-left:29px">
						<input id="AgreeId" name="AgreeId" type="checkbox" checked=""
						onclick="ckAgree();"> <a
							href="https://passport.e3mall.cn/xy.html" target="_blank"
							class="checkTitle">我已阅读并同意<font style="font-size:12px;">《宜立方商城用户注册协议》</font></a>
	...
	<script type="text/javascript">
		var REGISTER = {
			...
			beforeSubmit : function() {
				...
				//Math.random()生成随机数用于更换请求地址（浏览器会缓存上一次请求）
				$.ajax({
